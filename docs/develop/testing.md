...
- **Check-in** – only approved admins and superusers can write a check-in (guests and pending requests are refused), it goes when the booking goes and moves along with a crew move, a hand-over resets it, and it sends the guest nothing.
