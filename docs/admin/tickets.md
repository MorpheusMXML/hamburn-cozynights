...
- **The name** is only used for the greeting in e-mails ("Hi Ada,"). Without one, e-mails say "Hi,".
...
- **Only three columns leave your browser.** Shop exports also hold addresses, phone numbers and payment details; CozyNights never receives them.
