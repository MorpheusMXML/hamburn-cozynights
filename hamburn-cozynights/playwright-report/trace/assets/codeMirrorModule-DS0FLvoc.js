import { v as Ju } from './defaultSettingsView-GTWI-W_B.js';
var vi = { exports: {} },
	Zu = vi.exports,
	pa;
function mt() {
			...
			(function (ct, xt) {
				(function (b, pe) {
					...
					var b = navigator.userAgent,
						...
						O = /PhantomJS/.test(b),
						w = $ && (/Mobile\/\w+/.test(b) || navigator.maxTouchPoints > 2),
						M = /Android/.test(b),
...
`
					...
					function St(e, t, n, r) {
						...
						if (
							...
							Vt && Li(e.doc, t) < i.viewTo && hr(e);
						else if (n <= i.viewFrom)
							Vt && No(e.doc, n + r) > i.viewFrom ? hr(e) : ((i.viewFrom += r), (i.viewTo += r));
					...
					function Jn(e, t, n, r) {
						var i = Tr(e, t),
							o,
							l = e.display.view;
						if (!Vt || n == e.doc.first + e.doc.size) return { index: i, lineN: n };
					...
					function Ur(e, t) {
						e.state.delayingBlurEvent ||
							(e.state.focused &&
								(Ye(e, 'blur', e, t),
								(e.state.focused = !1),
								V(e.display.wrapper, 'CodeMirror-focused')),
					...
					function Xr(e, t) {
						...
						for (var i = 0; (i < 4 && n != e.display.barWidth) || r != e.display.barHeight; i++)
							(n != e.display.barWidth && e.options.lineWrapping && $n(e),
								al(e, yn(e)),
					...
					function Ki(e, t) {
						...
						return (
							...
							Vs(e, n.updateLineNumbers, t.dims),
					...
					var ri = 0,
						rr = null;
					k ? (rr = -0.53) : _ ? (rr = 15) : S ? (rr = -0.7) : $ && (rr = -1 / 3);
					function pl(e) {
						var t = e.wheelDeltaX,
							n = e.wheelDeltaY;
						return (
					...
					function bl(e) {
						(e.doc.direction == 'rtl' ? j : V)(e.display.lineDiv, 'CodeMirror-rtl');
					}
					function nu(e) {
						At(e, function () {
							(bl(e), St(e));
					...
					function $i(e, t) {
						var n = { from: it(t.from), to: gr(t), text: $t(e, t.from, t.to) };
						return (
						...
						if (
							...
							((a = we(l.changes)),
								ce(t.from, t.to) == 0 && ce(t.from, a.to) == 0
									? (a.to = gr(t))
									: l.changes.push($i(e, t)));
						else {
							var s = we(i.done);
							for (
								(!s || !s.ranges) && ii(e.sel, i.done),
									l = { changes: [$i(e, t)], generation: i.generation },
									i.done.push(l);
					...
					function oi(e, t, n, r, i) {
						(i == null && (i = e.cm && (e.cm.display.shift || e.extend)),
							gt(e, new Ot([Vi(e.sel.primary(), t, n, i)], 0), r));
					}
					function Tl(e, t, n) {
						for (
					...
					function El(e) {
						e.setSelection(B(e.firstLine(), 0), B(e.lastLine()), $e);
					}
					function Ol(e, t, n) {
						var r = {
							canceled: !1,
					...
					function $r(e, t, n, r, i) {
						...
						if (e.cm && !e.cm.curOp) return lt(e.cm, $r)(e, t, n, r, i);
						var o = new mr(e, i),
							l = ce(t, n);
					...
					function du(e, t, n, r, i) {
						...
						return (
							vr(e, function (s) {
								(a && (r.widgetNode = a.cloneNode(!0)), o.push($r(s, Ae(s, t), Ae(s, n), r, i)));
					...
					function hu(e, t) {
						for (var n = 0; n < t.length; n++) {
							var r = t[n],
								...
								l = e.clipPos(i.to);
							if (ce(o, l)) {
								var a = $r(e, o, l, r.primary, r.primary.type);
					...
					((Lt.prototype = K(Dn.prototype, {
						...
						getRange: function (e, t, n) {
							var r = $t(this, Ae(this, e), Ae(this, t));
						...
						markText: function (e, t, n) {
							return $r(this, Ae(this, e), Ae(this, t), n, (n && n.type) || 'range');
						},
						setBookmark: function (e, t) {
							...
							return ((e = Ae(this, e)), $r(this, e, e, n, 'bookmark'));
						},
...
`,
					...
					function Cu(e, t, n) {
						...
						return (
							(e.options.extraKeys && Vr(t, e.options.extraKeys, n, e)) ||
							Vr(t, e.options.keyMap, n, e)
						);
					}
					var Du = new Ce();
					function On(e, t, n, r) {
					...
					function _u(e) {
						(e.options.lineWrapping
							...
							: (V(e.display.wrapper, 'CodeMirror-wrap'), Ci(e)),
							Bi(e),
							St(e),
							gn(e),
							setTimeout(function () {
								...
								for (var i = this.doc.sel.ranges, o = -1, l = 0; l < i.length; l++) {
									...
									if (a.empty())
										...
										s.ch == 0 &&
											i.length == D.length &&
											D[l].from().ch > 0 &&
											eo(this.doc, l, new He(s, D[l].to()), $e);
									}
								}
							}),
									...
									(hi({ lineWise: !0, text: s.text }),
										a.type == 'cut' &&
											r.operation(function () {
												(r.setSelections(s.ranges, 0, $e), r.replaceSelection('', null, 'cut'));
											}));
								} else return;
								if (a.clipboardData) {
						...
						(je.prototype.pollContent = function () {
							...
							for (
								var x = e.doc.splitLines(Uu(e, a, h, l, u)),
									D = $t(e.doc, B(l, 0), B(u, ye(e.doc, u).text.length));
						...
						function D(L) {
							if (L.nodeType == 1) {
								...
								if (Z) {
									...
									ae.length && (ie = ae[0].find(0)) && x($t(e.doc, ie.from, ie.to).join(a));
									return;
								}
							...
							if (!Qe(r, l)) {
								if (r.somethingSelected()) hi({ lineWise: !1, text: r.getSelections() });
									...
									(hi({ lineWise: !0, text: a.text }),
										l.type == 'cut'
											? r.setSelections(a.ranges, null, $e)
											: ((n.prevInput = ''),
												(i.value = a.text.join(`
`)),
												v(i)));
...
`) > -1
						...
						(Ve.prototype.onContextMenu = function (e) {
							...
							a && n.doc.sel.contains(o) == -1 && lt(n, gt)(n.doc, pr(o), $e);
      ...
      outline: none; border-width: 0; outline: none; overflow: hidden; opacity: .05; filter: alpha(opacity=5);`));
					...
					return (
						Bt(Lt),
						(Ge.inputStyles = { textarea: Ve, contenteditable: je }),
		...
		va ||
			...
			(function (ct, xt) {
				(function (b) {
							...
							}),
							{
								startState: function (E) {
									return {
										...
										state: V ? 'block' : 'top',
										stateArg: null,
										context: new dt(V ? 'block' : 'top', E || 0, null)
									};
								},
								token: function (E, ee) {
					...
					function pe(J) {
						for (var P = {}, V = 0; V < J.length; ++V) P[J[V].toLowerCase()] = !0;
						return P;
					}
			...
			(function (ct, xt) {
				(function (b) {
					...
					(b.defineMode('xml', function (te, oe) {
						...
						function P(c, T, C) {
							if (c == 'word') return ((S = 'attribute'), V);
			...
			(function (ct, xt) {
				(function (b) {
					...
					(b.defineMode('javascript', function (pe, _) {
						...
						function ye() {
							return G(le('form'), kt, Me('{'), le('}'), Ne($t, '}'), xe, xe);
						}
						function $t() {
							return G(kt, Rt);
						}
						...
						return {
							...
							skipExpression: function (f) {
								V(f, 'atom', 'atom', 'true', new b.StringStream('', 2, null));
							}
						};
					}),
		...
		wa ||
			...
			(function (ct, xt) {
				(function (b) {
					...
					function I(ne, S) {
						for (var R in ne)
							for (var A = S[R] || (S[R] = []), $ = ne[R], ue = $.length - 1; ue >= 0; ue--)
								A.unshift($[ue]);
					}
					function Y(ne, S) {
								...
								if (
									...
									((N.token = function (F, G) {
										return F.match(P, !1)
											...
											: _(F, V, G.localMode.token(F, G.localState));
									}),
										(N.localMode = J),
				...
				(function (b) {
					...
					(b.defineMode('python', function (I, Y) {
						for (
							...
							R[A] || R.splice(A--, 1);
						var $ = Y.hangingIndent || I.indentUnit,
							ue = te,
							O = oe;
						...
						function G(T, C) {
							...
							if (
								...
								var j = '[({'.indexOf(y);
								if ((j != -1 && V(T, C, '])}'.slice(j, j + 1)), (j = '])}'.indexOf(y)), j != -1))
									if (Q(C).type == y) C.indent = C.scopes.pop().offset - $;
									else return ne;
							}
							return (
				...
				(function (b) {
					...
					b.defineMode('clike', function (g, y) {
						...
						function E(me, De) {
							...
							if ($e.test(be)) return ((we = be), null);
							if (be == '/') {
					...
					var Y =
						...
						$ = k('SEL instancetype id Class Protocol BOOL');
					function ue(g) {
						...
						function (pe, _) {
							...
							function p(v, d) {
								...
								if (!Oe && !d.setext && fe && d.indentation <= Fe && (qe = v.match(ne))) {
									...
									return (
										...
										(d.f = d.inline),
										_.highlightFormatting && (d.formatting = ['list', 'list-' + $e]),
										P(d)
									);
								} else {
							...
							function F(v, d) {
								...
								if (
									...
									var $e = v.string.indexOf('>', v.pos);
									if ($e != -1) {
										var dt = v.string.substring(v.start, $e);
				...
				(function (b) {
					...
					((b.defineSimpleMode = function (S, R) {
						...
						(b.simpleMode = function (S, R) {
							...
							if ($) for (var q in $) $.hasOwnProperty(q) && (X[q] = $[q]);
							return X;
						}));
					function pe(S, R) {
					...
					function Q(S, R) {
						return function (A, $) {
							...
							if ($.local)
								if ($.local.end && A.match($.local.end)) {
									var O = $.local.endToken || null;
									return (($.local = $.localState = null), O);
								} else {
									var O = $.local.mode.token(A, $.localState),
										w;
									return (
										$.local.endScan &&
											(w = $.local.endScan.exec(A.current())) &&
											(A.pos = A.start + w.index),
										O
									);
								}
							for (var M = S[$.state], N = 0; N < M.length; N++) {
								var z = M[N],
								...
								if (X) {
									(z.data.next
										...
										: z.data.push
											...
											: z.data.pop && $.stack && $.stack.length && ($.state = $.stack.pop()),
										z.data.mode && I(R, $, z.data.mode, z.token),
										z.data.indent && $.indent.push(A.indentation() + R.indentUnit),
										z.data.dedent && $.indent.pop());
									var q = z.token;
									if (
										(q && q.apply && (q = q(X)),
										...
										for (var p = 2; p < X.length; p++)
											X[p] &&
												($.pending || ($.pending = [])).push({ text: X[p], token: z.token[p - 1] });
					...
					function k(S, R) {
						...
						for (var $ in S)
							if (S.hasOwnProperty($)) {
								if (!R.hasOwnProperty($) || !k(S[$], R[$])) return !1;
								A++;
							}
						for (var $ in R) R.hasOwnProperty($) && A--;
						return A == 0;
					}
					function I(S, R, A, $) {
						var ue;
					...
					function ne(S, R) {
						return function (A, $, ue) {
							if (A.local && A.local.mode.indent) return A.local.mode.indent(A.localState, $, ue);
							if (
								A.indent == null ||
								A.local ||
		...
		za ||
			...
			(function (ct, xt) {
				(function (b) {
					...
					function Q(S, R, A) {
						var $ = S.getLineHandle(R.line),
							ue = R.ch - 1,
							O = A && A.afterCursor;
						O == null && (O = /(^| )cm-fat-cursor($| )/.test(S.getWrapperElement().className));
						var w = oe(A),
							M =
								(!O && ue >= 0 && w.test($.text.charAt(ue)) && te[$.text.charAt(ue)]) ||
								(w.test($.text.charAt(ue + 1)) && te[$.text.charAt(++ue)]);
						if (!M) return null;
							...
							if (q) {
								...
								if (!(q.length > O))
									for (X == R.line && (p = R.ch - (A < 0 ? 1 : 0)); p != W; p += A) {
										...
										if (
											N.test(J) &&
											($ === void 0 || (S.getTokenTypeAt(_(X, p + 1)) || '') == ($ || ''))
										) {
											var P = te[J];
					...
					function I(S, R, A) {
						for (
							var $ = S.state.matchBrackets.maxHighlightLineLength || 1e3,
							...
							if (N && (N.match || ue !== !1) && S.getLine(N.from.line).length <= $) {
					...
					(b.defineOption('matchBrackets', !1, function (S, R, A) {
						...
						b.defineExtension('scanForBracket', function (S, R, A, $) {
							return k(this, S, R, A, $);
						}));
				});
			})()),
...
` +
							...
							var P = M.exec(z);
							if (P) {
								var V = z.slice(0, P.index).split(`
`),
									F = P[0].split(`
`),
									G = N.line + V.length - 1,
									c = V[V.length - 1].length;
								return {
									from: pe(G, c),
									to: pe(
										G + F.length - 1,
...
`),
					...
					function $(w, M, N, z) {
						...
						e: for (var p = N.line, W = N.ch, J = w.lastLine() + 1 - q.length; p <= J; p++, W = 0) {
							...
							if (q.length == 1) {
								...
								var N = A(P, V, F, X) + W;
								return {
									from: pe(p, A(P, V, F, X) + W),
									to: pe(p, A(P, V, F + q[0].length, X) + W)
								};
							} else {
								var G = V.length - q[0].length;
								if (V.slice(G) != q[0]) continue e;
					...
					function ue(w, M, N, z) {
						...
						e: for (
							...
							var V = X(P);
							if (q.length == 1) {
								var F = V.lastIndexOf(q[0]);
								if (F == -1) continue e;
								return { from: pe(p, A(P, V, F, X)), to: pe(p, A(P, V, F + q[0].length, X)) };
							} else {
								var G = q[q.length - 1];
								if (V.slice(0, G.length) != G) continue e;
...
`
					...
					function A(p, W, J, P) {
						var V = te(p);
						if (V.query) return $(p, W);
						var F = p.getSelection() || V.lastQuery;
						if ((F instanceof RegExp && F.source == 'x^' && (F = null), J && p.openDialog)) {
							var G = null,
								c = function (T, C) {
									(b.e_stop(C),
										T &&
											(T != V.queryText && (R(p, V, T), (V.posFrom = V.posTo = p.getCursor())),
											G && (G.style.opacity = 1),
											$(p, C.shiftKey, function (g, y) {
												var j;
												y.line < 3 &&
							...
							I(p, w(p), 'Search for:', F, function (T) {
								T &&
									...
									p.operation(function () {
										(R(p, V, T), (V.posFrom = V.posTo = p.getCursor()), $(p, W));
									});
							});
					}
					function $(p, W, J) {
						p.operation(function () {
							var P = te(p),
								V = Q(p, P.query, W ? P.posFrom : P.posTo);
							(!V.find(W) &&
								((V = Q(p, P.query, W ? b.Pos(p.lastLine()) : b.Pos(p.firstLine(), 0))),
								!V.find(W))) ||
								(p.setSelection(V.from(), V.to()),
								p.scrollIntoView({ from: V.from(), to: V.to() }, 20),
								(P.posFrom = V.from()),
								(P.posTo = V.to()),
								J && J(V.from(), V.to()));
						});
					...
					function X(p, W, J) {
						p.operation(function () {
							for (var P = Q(p, W); P.findNext(); )
								if (typeof W != 'string') {
									var V = p.getRange(P.from(), P.to()).match(W);
									P.replace(
					...
					function q(p, W) {
						if (!p.getOption('readOnly')) {
							var J = p.getSelection() || te(p).lastQuery,
								...
								V = O('', null, O('span', { className: 'CodeMirror-search-label' }, P), M(p));
							I(p, V, P, J, function (F) {
								F &&
									((F = S(F)),
