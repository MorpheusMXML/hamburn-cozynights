...
<div class="intel-dashboard">
    <div class="chart-container pie-box">
        ...
        <div class="pie-overlay">
            <span class="percentage">{totalBeds > 0 ? Math.round((occupiedBeds/totalBeds)*100) : 0}%</span>
...
<style>
    ...
    .pie-box { width: 150px; height: 150px; flex-shrink: 0; }
    .line-box { flex: 1; height: 150px; }
    ...
    .percentage { font-size: 1.25rem; font-weight: 900; color: #f472b6; text-shadow: 0 0 10px rgba(244, 114, 182, 0.3); }
    .label { font-size: 0.5rem; color: #444; font-weight: 900; letter-spacing: 1px; }
</style>