...
<div class="edit-container">
  ...
  <form method="POST" action="?/create" class="edit-form">
    ...
    <div class="form-group">
      ...
      <input type="text" id="name" name="name" bind:value={name} placeholder="e.g. Eagle's Nest" required />
    </div>
...
<style>
  ...
  .edit-form { display: flex; flex-direction: column; gap: 1.5rem; margin-top: 2rem; }
  ...
  .btn-save { background: #22c55e; color: white; border: none; padding: 0.8rem 1.5rem; border-radius: 6px; cursor: pointer; font-weight: bold; }
  .btn-cancel { color: #888; text-decoration: none; padding: 0.8rem; }
</style>